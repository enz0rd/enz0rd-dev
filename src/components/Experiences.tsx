const Experiences = () => {
    return (
        <div id='experiences' className="w-full lg:justify-end py-[5rem] flex align-middle justify-center col-span-1 bg-gradient-to-br from-[#FFDA58] via-[#FDC500] to-[#BB9200]">

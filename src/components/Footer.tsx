...
const Footer = () => {
    return (
        <div className="w-full h-[25vh] py-5 justify-center bg-zinc-800">
            <div className="w-[90%] flex justify-between m-auto align-middle">
                <div className="flex flex-col gap-3">
                    <div className="flex flex-row justify-center gap-2">
                        <h1 className="text-2xl m-auto text-zinc-50 font-bold">enz0rd<span className="bg-clip-text text-transparent bg-gradient-to-r from-[#FDC500] to-[#FFE383]">.dev</span></h1>
            ...
            <div className="w-[80%] mt-6 flex flex-col align-middle m-auto gap-4">

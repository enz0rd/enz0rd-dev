...
const Projects = () => {
    return (
        <div id="projects" className="w-full border-2 justify-center lg:px-[10%]">
            <div className="w-full lg:w-[1280px] m-auto flex flex-col gap-5 px-[2rem] py-[3rem] bg-zinc-50 h-fit">
